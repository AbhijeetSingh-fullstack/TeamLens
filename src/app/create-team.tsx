        ...
        <ScrollView className="flex-1 px-6 pt-6" contentContainerStyle={{ paddingBottom: 60 }} showsVerticalScrollIndicator={false}>
          ...
          <View className="mb-6">
            <View className="flex-row items-center gap-2 mb-3">
              ...
              <Text className="text-slate-800 text-xs font-bold">Add Team</Text>
            </View>
            <Text className="text-2xl font-bold text-slate-800 mb-2">New Team Setup</Text>
            <Text className="text-slate-500 text-sm leading-5">
              Configure the workspace environment for a new team entity within your network.
            </Text>
          </View>
